...
//             className="bg-pink-500 hover:bg-pink-600 text-white px-10 py-5 rounded-full font-black text-xl shadow-[0_10px_0_#9d174d] transition-all transform hover:-translate-y-2 active:translate-y-1 uppercase tracking-tight"
//           >
//             Inscreva-se Agora
//           </a> */}
//         </div>
